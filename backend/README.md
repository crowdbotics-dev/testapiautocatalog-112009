...
## Project Structure
    ...
    ├── testapiautocatalog_112009  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_112009`
...
2. Clone this repo and `cd testapiautocatalog_112009`
